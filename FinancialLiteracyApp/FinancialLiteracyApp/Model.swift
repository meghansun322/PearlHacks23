...
struct Message: Hashable, Codable {
    ...
    static var example_message: Message = Message(user: "meghansun322", message: "I loved @Financial_Feminist Podcasts! Super helpful!", upvote: 15, downvote: 2, isUpvoted: false, isDownvoted: false)
